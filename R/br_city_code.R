#' City code according to National Institute of Geography and Statistics
#'
...
#' }
#'
#' @format A data frame with 5570 rows and 7 variables
#' @source \url{https://github.com/luizpedone/municipal-brazilian-geodata}
"br_city_code"
#> [1] "br_city_code"
