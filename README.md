...
[![Travis-CI Build Status](https://travis-ci.org/jjesusfilho/cidades.svg?branch=master)](https://travis-ci.org/jjesusfilho/cidades) [![Coverage status](https://codecov.io/gh/jjesusfilho/cidades/branch/master/graph/badge.svg)](https://codecov.io/github/jjesusfilho/cidades?branch=master) [![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/jjesusfilho/cidades?branch=master&svg=true)](https://ci.appveyor.com/project/jjesusfilho/cidades)
